    ...
    <Disclosure as="nav" className="bg-gray-800 sticky top-0 z-10">
      <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div class="flex px-8 py-2 rounded-md border-2 bg-white border-blue-200 overflow-hidden max-w-md mx-auto font-[sans-serif]">
            <svg
            ...
            <input
              ...
              class="w-full outline-none  text-gray-600 text-sm"
            />
          </div>
          <div
            className={`${
